...
<section id="intro-section">
    <div class="inner">
        ...
        <div id="intro-section-title" style="display: none;">
...
<section id="meditation-center-section">
    <div class="inner">
        <h2>Meditation Center</h2>
        <div class="index-desc-wrapper">
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit excepturi sunt nesciunt, magnam dignissimos vitae at odio saepe odit itaque deleniti nulla consequatur molestias eum, assumenda a quibusdam, nam delectus!</p>
            <p>Nemo distinctio nam incidunt iure, dolores eveniet reiciendis consequatur magnam quam quis accusamus autem quas repellat ducimus, veniam quia unde non debitis placeat. Voluptatibus cupiditate aut dolorem neque cumque accusantium.</p>
            <p>Officiis, ipsum ab reiciendis ea voluptatum ullam tempora ducimus nobis quas odio repellendus velit ipsam labore. Dicta, explicabo commodi, at facilis voluptate consectetur possimus quibusdam quod delectus corporis cumque provident?</p>
            <p>Dolorum, illum. Iusto blanditiis, asperiores et consequuntur facilis ipsum fugit ex dolores libero atque nostrum distinctio officiis ad. Obcaecati, porro aliquid? Rerum laboriosam nobis saepe recusandae obcaecati incidunt perspiciatis perferendis.</p>
        </div>
